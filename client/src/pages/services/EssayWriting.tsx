...
const EssayWriting: React.FC = () => {
  const features = [
    {
      icon: BookOpen,
      title: 'Expert Essay Writers',
      description: 'Professional writers with advanced degrees in various academic fields',
      color: 'bg-navy/10 text-navy'
    },
    {
      icon: Clock,
      title: 'Timely Delivery',
      description: 'Get your essays delivered on time, every time with quality assurance',
      color: 'bg-purple-50 text-purple-600'
    },
    {
      icon: Shield,
      title: 'Plagiarism-Free',
      description: 'Original content guaranteed with comprehensive plagiarism reports',
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      text: 'The essay writing service exceeded my expectations. The writer understood my requirements perfectly and delivered a well-structured, compelling essay.',
    ...
    },
    {
      ...
      rating: 5,
      text: 'Outstanding quality and professional service. My argumentative essay was well-researched and perfectly formatted according to APA guidelines.',
  ...
  const pricingPlans = [
    {
      level: 'High School',
      price: '$12.99',
      features: ['Basic essay structure', 'Standard formatting', '48-hour delivery', 'Free revisions']
    },
    {
      level: 'College',
      price: '$15.99',
      features: ['Advanced analysis', 'Multiple sources', '24-hour delivery', 'Plagiarism report']
    },
    {
      level: 'University',
      price: '$18.99',
      features: ['Expert-level writing', 'Extensive research', '12-hour delivery', 'Priority support']
    }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 text-center lg:text-left">
              <div className="flex items-center justify-center lg:justify-start gap-3 mb-4">
                ...
                <h5 className="text-gray-300 font-medium">Professional Essay Writing Service</h5>
              </div>
              
              <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight">
                Expert <span className="text-purple-400">Essay Writing</span><br />
                Service for Academic <span className="text-cyan-400">Success</span>
              </h1>
              
              <p className="text-xl text-gray-200 leading-relaxed max-w-lg mx-auto lg:mx-0">
                Get professionally written essays that meet your academic requirements. Our expert writers deliver original, well-researched content tailored to your specific needs.
              </p>
            ...
            <div className="relative">
              <img 
                src="https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1473&h=982&q=80" 
              ...
              <div className="hidden sm:block absolute -bottom-4 -left-4 bg-white rounded-xl p-4 shadow-lg animate-float">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-bold text-green-600">A+ Quality</div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We provide comprehensive essay writing assistance with a focus on quality, originality, and timely delivery
            </p>
          </div>
      ...
      <section className="py-20 bg-blue-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Our expert writers can handle any type of essay across all academic levels and subjects
            </p>
          </div>
      ...
      <section id="pricing" className="py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Choose the academic level that matches your requirements. All prices are per page (275 words)
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Simple, transparent, and efficient process to get your essay written by experts
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { step: '01', title: 'Place Order', description: 'Fill out the order form with your essay requirements', icon: FileText },
              { step: '02', title: 'Writer Assignment', description: 'We assign the best writer for your subject and academic level', icon: Users },
              { step: '03', title: 'Writing Process', description: 'Your writer researches and crafts your essay with attention to detail', icon: BookOpen },
              { step: '04', title: 'Quality Check', description: 'We review, edit, and check for plagiarism before delivery', icon: Shield }
            ].map((item, index) => (
      ...
      <section className="py-20 bg-blue-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">
              What Our Clients Say About Our Essay Writing
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Read testimonials from satisfied students who achieved academic success with our essay writing service
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-4xl font-bold mb-6">
            Ready to Get Your Essay Written by Experts?
          </h2>
          <p className="text-xl text-blue-100 mb-10 max-w-3xl mx-auto leading-relaxed">
            Join thousands of students who have achieved academic success with our professional essay writing service. 
